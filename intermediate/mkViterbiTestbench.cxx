...
void MOD_mkViterbiTestbench::RL_load_m_and_n()
{
  ...
  DEF_m__h764 = INST_n_and_m.METH_sub(1u);
  DEF_n__h763 = INST_n_and_m.METH_sub(0u);
  ...
  if (DEF_NOT_viterbi_get_n_and_m_loaded___d2)
    INST_viterbi.METH_n_and_m_load(DEF_n__h763, DEF_m__h764);
}

void MOD_mkViterbiTestbench::RL_read_66()
{
  tUInt32 DEF_x__h1055;
  DEF_x__h1055 = INST_viterbi.METH_read_transition_idx();
  INST_read_transition_tb.METH_write((tUInt8)1u);
  INST_transition_idx_tb.METH_write(DEF_x__h1055);
}

void MOD_mkViterbiTestbench::RL_read_transition_matrix()
{
  tUInt32 DEF_data__h1075;
  tUInt32 DEF_i__h1096;
  DEF_i__h1096 = INST_transition_idx_tb.METH_read();
  DEF_data__h1075 = INST_p_transition.METH_sub(DEF_i__h1096);
  INST_viterbi.METH_send_transition_data(DEF_data__h1075);
  INST_read_transition_tb.METH_write((tUInt8)0u);
}

void MOD_mkViterbiTestbench::RL_read_77()
{
  tUInt32 DEF_x__h1147;
  DEF_x__h1147 = INST_viterbi.METH_read_emission_idx();
  INST_read_emission_tb.METH_write((tUInt8)1u);
  INST_emission_idx_tb.METH_write(DEF_x__h1147);
}

void MOD_mkViterbiTestbench::RL_read_emission_matrix()
{
  tUInt32 DEF_data__h1164;
  tUInt32 DEF_i__h1183;
  DEF_i__h1183 = INST_emission_idx_tb.METH_read();
  DEF_data__h1164 = INST_p_emission.METH_sub(DEF_i__h1183);
  INST_viterbi.METH_send_emission_data(DEF_data__h1164);
  INST_read_emission_tb.METH_write((tUInt8)0u);
}

void MOD_mkViterbiTestbench::RL_read_88()
{
  tUInt32 DEF_x__h1234;
  DEF_x__h1234 = INST_viterbi.METH_read_outcome_idx();
  INST_read_outcome_tb.METH_write((tUInt8)1u);
  INST_outcome_idx_tb.METH_write(DEF_x__h1234);
}

void MOD_mkViterbiTestbench::RL_read_outcome_matrix()
{
  tUInt32 DEF_data__h1249;
  tUInt32 DEF_i__h1268;
  DEF_i__h1268 = INST_outcome_idx_tb.METH_read();
  DEF_data__h1249 = INST_inputs.METH_sub(DEF_i__h1268);
  INST_viterbi.METH_send_outcome_data(DEF_data__h1249);
