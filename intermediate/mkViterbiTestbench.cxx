...
static std::string const __str_literal_5("Index: %h", 9u);
...
void MOD_mkViterbiTestbench::RL_read_outcome_matrix()
{
  ...
  tUInt32 DEF_i__h1336;
  DEF_i__h1336 = INST_outcome_idx_tb.METH_read();
  DEF_data__h1318 = INST_inputs.METH_sub(DEF_i__h1336);
  if (!(PORT_RST_N == (tUInt8)0u))
    dollar_display(sim_hdl, this, "s,32", &__str_literal_5, DEF_i__h1336);
  INST_viterbi.METH_send_outcome_data(DEF_data__h1318);
