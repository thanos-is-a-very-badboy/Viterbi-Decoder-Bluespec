...
void MOD_mkViterbiTestbench::init_symbols_0()
{
  ...
  init_symbol(&symbols[3u], "p_emission", SYM_MODULE, &INST_p_emission);
  init_symbol(&symbols[4u], "p_transition", SYM_MODULE, &INST_p_transition);
  init_symbol(&symbols[5u], "RL_load_m_and_n", SYM_RULE);
  init_symbol(&symbols[6u], "RL_read_66", SYM_RULE);
  init_symbol(&symbols[7u], "RL_read_77", SYM_RULE);
  init_symbol(&symbols[8u], "RL_read_emission_matrix", SYM_RULE);
  init_symbol(&symbols[9u], "RL_read_transition_matrix", SYM_RULE);
  init_symbol(&symbols[10u], "read_emission_tb", SYM_MODULE, &INST_read_emission_tb);
  init_symbol(&symbols[11u], "read_transition_tb", SYM_MODULE, &INST_read_transition_tb);
  init_symbol(&symbols[12u], "transition_idx_tb", SYM_MODULE, &INST_transition_idx_tb);
  init_symbol(&symbols[13u], "viterbi", SYM_MODULE, &INST_viterbi);
}
...
void MOD_mkViterbiTestbench::RL_load_m_and_n()
{
  ...
  tUInt32 DEF_outcome__h773;
  tUInt32 DEF_n__h771;
  tUInt32 DEF_m__h772;
  tUInt8 DEF_AVMeth_viterbi_get_n_and_m_loaded;
  DEF_m__h772 = INST_n_and_m.METH_sub(1u);
  DEF_n__h771 = INST_n_and_m.METH_sub(0u);
  DEF_outcome__h773 = INST_inputs.METH_sub(0u);
  ...
  if (DEF_NOT_viterbi_get_n_and_m_loaded___d2)
    INST_viterbi.METH_n_and_m_load(DEF_n__h771, DEF_m__h772, DEF_outcome__h773);
}

void MOD_mkViterbiTestbench::RL_read_66()
{
  tUInt32 DEF_x__h1004;
  DEF_x__h1004 = INST_viterbi.METH_read_transition_idx();
  INST_read_transition_tb.METH_write((tUInt8)1u);
  INST_transition_idx_tb.METH_write(DEF_x__h1004);
}

void MOD_mkViterbiTestbench::RL_read_transition_matrix()
{
  tUInt32 DEF_data__h1024;
  tUInt32 DEF_i__h1045;
  DEF_i__h1045 = INST_transition_idx_tb.METH_read();
  DEF_data__h1024 = INST_p_transition.METH_sub(DEF_i__h1045);
  INST_viterbi.METH_send_transition_data(DEF_data__h1024);
  INST_read_transition_tb.METH_write((tUInt8)0u);
}

void MOD_mkViterbiTestbench::RL_read_77()
{
  tUInt32 DEF_x__h1096;
  DEF_x__h1096 = INST_viterbi.METH_read_emission_idx();
  INST_read_emission_tb.METH_write((tUInt8)1u);
  INST_emission_idx_tb.METH_write(DEF_x__h1096);
}

void MOD_mkViterbiTestbench::RL_read_emission_matrix()
{
  tUInt32 DEF_data__h1111;
  tUInt32 DEF_i__h1130;
  DEF_i__h1130 = INST_emission_idx_tb.METH_read();
  DEF_data__h1111 = INST_p_emission.METH_sub(DEF_i__h1130);
  INST_viterbi.METH_send_emission_data(DEF_data__h1111);
