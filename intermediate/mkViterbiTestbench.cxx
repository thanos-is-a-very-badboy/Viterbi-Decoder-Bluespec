...
void MOD_mkViterbiTestbench::RL_load_m_and_n()
{
  ...
  DEF_m__h773 = INST_n_and_m.METH_sub(1u);
  DEF_n__h772 = INST_n_and_m.METH_sub(0u);
  ...
  if (DEF_NOT_viterbi_get_n_and_m_loaded___d2)
    INST_viterbi.METH_n_and_m_load(DEF_n__h772, DEF_m__h773);
}

void MOD_mkViterbiTestbench::RL_read_66()
{
  tUInt32 DEF_x__h1064;
  DEF_x__h1064 = INST_viterbi.METH_read_transition_idx();
  INST_read_transition_tb.METH_write((tUInt8)1u);
  INST_transition_idx_tb.METH_write(DEF_x__h1064);
}

void MOD_mkViterbiTestbench::RL_read_transition_matrix()
{
  tUInt32 DEF_data__h1084;
  tUInt32 DEF_i__h1105;
  DEF_i__h1105 = INST_transition_idx_tb.METH_read();
  DEF_data__h1084 = INST_p_transition.METH_sub(DEF_i__h1105);
  INST_viterbi.METH_send_transition_data(DEF_data__h1084);
...
void MOD_mkViterbiTestbench::RL_read_77()
{
  ...
  DEF_x__h1156 = INST_viterbi.METH_read_emission_idx();
  INST_read_emission_tb.METH_write((tUInt8)1u);
  INST_emission_idx_tb.METH_write(DEF_x__h1156);
}

void MOD_mkViterbiTestbench::RL_read_emission_matrix()
{
  tUInt32 DEF_data__h1173;
  tUInt32 DEF_i__h1192;
  DEF_i__h1192 = INST_emission_idx_tb.METH_read();
  DEF_data__h1173 = INST_p_emission.METH_sub(DEF_i__h1192);
  INST_viterbi.METH_send_emission_data(DEF_data__h1173);
  INST_read_emission_tb.METH_write((tUInt8)0u);
}

void MOD_mkViterbiTestbench::RL_read_88()
{
  tUInt32 DEF_x__h1243;
  DEF_x__h1243 = INST_viterbi.METH_read_outcome_idx();
  INST_read_outcome_tb.METH_write((tUInt8)1u);
  INST_outcome_idx_tb.METH_write(DEF_x__h1243);
}

void MOD_mkViterbiTestbench::RL_read_outcome_matrix()
{
  tUInt32 DEF_data__h1258;
  tUInt32 DEF_i__h1277;
  DEF_i__h1277 = INST_outcome_idx_tb.METH_read();
  DEF_data__h1258 = INST_inputs.METH_sub(DEF_i__h1277);
  INST_viterbi.METH_send_outcome_data(DEF_data__h1258);
