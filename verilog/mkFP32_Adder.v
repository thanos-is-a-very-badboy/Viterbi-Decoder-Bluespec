...
module mkFP32_Adder(CLK,
  ...
  wire [23 : 0] shifted_part__h752,
		shifted_part__h955,
		sm1__h515,
		sm2__h516,
		y__h799,
		y__h995,
		y_avValue_snd_snd_fst__h1098,
		y_avValue_snd_snd_fst__h1109,
		y_avValue_snd_snd_snd__h1108;
  wire [22 : 0] IF_guard1_1_OR_sticky1_2_3_OR_rca_calculate_sh_ETC___d58,
		match_exponents_num1_BITS_22_TO_0__q2,
		match_exponents_num2_BITS_22_TO_0__q1,
		x__h1523,
		x__h1948;
  wire [7 : 0] diff__h607,
	       diff__h838,
	       ...
	       y__h801,
	       y__h997,
	       y_avValue_fst__h1054,
	       y_avValue_snd_fst__h1093;
  ...
  assign final_mantissa_D_IN =
	     rca_calculate[24] ?
	       (rca_calculate[0] ?
		  IF_guard1_1_OR_sticky1_2_3_OR_rca_calculate_sh_ETC___d58 :
		  rca_calculate[23:1]) :
	       (guard1 ?
  ...
  assign guard1_D_IN =
	     match_exponents_num1_BITS_30_TO_23_ULE_match_e_ETC___d5 ?
	       diff__h838 != 8'd0 && x__h870 :
	       diff__h607 != 8'd0 && x__h644 ;
  assign guard1_EN =
	     EN_match_exponents &&
	     !match_exponents_num1_BITS_30_TO_23_EQ_match_ex_ETC___d3 ;
  ...
  // remaining internal signals
  assign IF_guard1_1_OR_sticky1_2_3_OR_rca_calculate_sh_ETC___d58 =
  ...
  assign i__h664 = diff__h607 - 8'd1 ;
  assign i__h889 = diff__h838 - 8'd1 ;
  assign match_exponents_num1_BITS_22_TO_0__q2 = match_exponents_num1[22:0] ;
  ...
  assign match_exponents_num1_BITS_30_TO_23_ULE_match_e_ETC___d5 =
	     match_exponents_num1[30:23] <= match_exponents_num2[30:23] ;
  assign match_exponents_num2_BITS_22_TO_0__q1 = match_exponents_num2[22:0] ;
  assign shifted_part__h752 = sm2__h516 & y__h799 ;
  assign shifted_part__h955 = sm2__h516 & y__h995 ;
  assign sm1__h515 = { 1'b1, match_exponents_num1[22:0] } ;
  assign sm2__h516 = { 1'b1, match_exponents_num2[22:0] } ;
  assign x__h1523 = rca_calculate[23:1] + 23'd1 ;
  assign x__h1948 = rca_calculate[22:0] + 23'd1 ;
  assign x__h644 = match_exponents_num2_BITS_22_TO_0__q1[i__h664[4:0]] ;
  assign x__h762 = shifted_part__h752 != 24'd0 ;
  assign x__h870 = match_exponents_num1_BITS_22_TO_0__q2[i__h889[4:0]] ;
  assign x__h965 = shifted_part__h955 != 24'd0 ;
  assign y__h799 = 24'hFFFFFF >> y__h801 ;
  assign y__h801 = 8'd25 - diff__h607 ;
  assign y__h995 = 24'hFFFFFF >> y__h997 ;
  assign y__h997 = 8'd25 - diff__h838 ;
  assign y_avValue_fst__h1054 =
	     match_exponents_num1_BITS_30_TO_23_ULE_match_e_ETC___d5 ?
	       diff__h838 :
	       diff__h607 ;
  assign y_avValue_snd_fst__h1093 =
	     match_exponents_num1_BITS_30_TO_23_ULE_match_e_ETC___d5 ?
	       match_exponents_num2[30:23] :
	       match_exponents_num1[30:23] ;
  assign y_avValue_snd_snd_fst__h1098 =
	     match_exponents_num1_BITS_30_TO_23_ULE_match_e_ETC___d5 ?
	       y_avValue_snd_snd_fst__h1109 :
	       sm1__h515 ;
  assign y_avValue_snd_snd_fst__h1109 = sm1__h515 >> diff__h838 ;
  assign y_avValue_snd_snd_snd__h1108 = sm2__h516 >> diff__h607 ;
