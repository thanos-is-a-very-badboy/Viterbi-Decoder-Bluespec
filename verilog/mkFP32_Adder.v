...
//
// On Wed Nov  5 16:28:46 IST 2025
//
//
// Ports:
// Name                         I/O  size props
...
module mkFP32_Adder(CLK,
  ...
  wire [24 : 0] _0b0_CONCAT_shifted_mantissa_1_6_7_PLUS_0b0_CON_ETC___d50;
  wire [23 : 0] shifted_part__h708,
		shifted_part__h911,
		sm1__h471,
		sm2__h472,
		y__h755,
		y__h951,
		y_avValue_snd_snd_fst__h1054,
		y_avValue_snd_snd_fst__h1065,
		y_avValue_snd_snd_snd__h1064;
  wire [22 : 0] IF_guard1_3_OR_sticky1_4_5_OR_0b0_CONCAT_shift_ETC___d60,
  ...
  wire [7 : 0] diff__h563,
	       ...
	       y__h757,
	       y__h953,
	       y_avValue_fst__h1010,
	       y_avValue_snd_fst__h1049;
  ...
  assign final_mantissa_D_IN =
	     _0b0_CONCAT_shifted_mantissa_1_6_7_PLUS_0b0_CON_ETC___d50[24] ?
	       (_0b0_CONCAT_shifted_mantissa_1_6_7_PLUS_0b0_CON_ETC___d50[0] ?
		  IF_guard1_3_OR_sticky1_4_5_OR_0b0_CONCAT_shift_ETC___d60 :
		  _0b0_CONCAT_shifted_mantissa_1_6_7_PLUS_0b0_CON_ETC___d50[23:1]) :
	       (guard1 ?
		  ((sticky1 ||
		    _0b0_CONCAT_shifted_mantissa_1_6_7_PLUS_0b0_CON_ETC___d50[0]) ?
		     x__h1893 :
		     _0b0_CONCAT_shifted_mantissa_1_6_7_PLUS_0b0_CON_ETC___d50[22:0]) :
		  _0b0_CONCAT_shifted_mantissa_1_6_7_PLUS_0b0_CON_ETC___d50[22:0]) ;
  ...
  assign guard1_D_IN =
	     match_exponents_num1_BITS_30_TO_23_ULE_match_e_ETC___d5 ?
	       diff__h794 != 8'd0 && x__h826 :
	       diff__h563 != 8'd0 && x__h600 ;
  assign guard1_EN =
	     EN_match_exponents &&
	     !match_exponents_num1_BITS_30_TO_23_EQ_match_ex_ETC___d3 ;

  // register man_carry
  assign man_carry_D_IN =
	     _0b0_CONCAT_shifted_mantissa_1_6_7_PLUS_0b0_CON_ETC___d50[24] ;
  ...
  // remaining internal signals
  assign IF_guard1_3_OR_sticky1_4_5_OR_0b0_CONCAT_shift_ETC___d60 =
	     (guard1 | sticky1 ||
	      _0b0_CONCAT_shifted_mantissa_1_6_7_PLUS_0b0_CON_ETC___d50[1]) ?
	       x__h1468 :
	       _0b0_CONCAT_shifted_mantissa_1_6_7_PLUS_0b0_CON_ETC___d50[23:1] ;
  assign _0b0_CONCAT_shifted_mantissa_1_6_7_PLUS_0b0_CON_ETC___d50 =
	     { 1'b0, shifted_mantissa_1 } + { 1'b0, shifted_mantissa_2 } ;
  assign diff__h563 =
	     match_exponents_num1[30:23] - match_exponents_num2[30:23] ;
  assign diff__h794 =
	     match_exponents_num2[30:23] - match_exponents_num1[30:23] ;
  assign i__h620 = diff__h563 - 8'd1 ;
  assign i__h845 = diff__h794 - 8'd1 ;
  ...
  assign shifted_part__h708 = sm2__h472 & y__h755 ;
  assign shifted_part__h911 = sm2__h472 & y__h951 ;
  assign sm1__h471 = { 1'b1, match_exponents_num1[22:0] } ;
  assign sm2__h472 = { 1'b1, match_exponents_num2[22:0] } ;
  assign x__h1468 =
	     _0b0_CONCAT_shifted_mantissa_1_6_7_PLUS_0b0_CON_ETC___d50[23:1] +
	     23'd1 ;
  assign x__h1893 =
	     _0b0_CONCAT_shifted_mantissa_1_6_7_PLUS_0b0_CON_ETC___d50[22:0] +
	     23'd1 ;
  assign x__h600 = match_exponents_num2_BITS_22_TO_0__q2[i__h620[4:0]] ;
  assign x__h718 = shifted_part__h708 != 24'd0 ;
  assign x__h826 = match_exponents_num1_BITS_22_TO_0__q1[i__h845[4:0]] ;
  assign x__h921 = shifted_part__h911 != 24'd0 ;
  assign y__h755 = 24'hFFFFFF >> y__h757 ;
  assign y__h757 = 8'd25 - diff__h563 ;
  assign y__h951 = 24'hFFFFFF >> y__h953 ;
  assign y__h953 = 8'd25 - diff__h794 ;
  assign y_avValue_fst__h1010 =
	     match_exponents_num1_BITS_30_TO_23_ULE_match_e_ETC___d5 ?
	       diff__h794 :
	       diff__h563 ;
  assign y_avValue_snd_fst__h1049 =
	     match_exponents_num1_BITS_30_TO_23_ULE_match_e_ETC___d5 ?
	       match_exponents_num2[30:23] :
	       match_exponents_num1[30:23] ;
  assign y_avValue_snd_snd_fst__h1054 =
	     match_exponents_num1_BITS_30_TO_23_ULE_match_e_ETC___d5 ?
	       y_avValue_snd_snd_fst__h1065 :
	       sm1__h471 ;
  assign y_avValue_snd_snd_fst__h1065 = sm1__h471 >> diff__h794 ;
  assign y_avValue_snd_snd_snd__h1064 = sm2__h472 >> diff__h563 ;
