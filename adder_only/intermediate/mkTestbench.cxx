 ...
 * 
 * On Fri Oct 31 15:06:44 IST 2025
 * 
 */
...
{
  INST_adder.METH_match_exponents(3224075160u, 3210707253u);
...
{
  tUInt32 DEF_x__h343;
  DEF_x__h343 = INST_adder.METH_get_res();
  INST_res.METH_write(DEF_x__h343);
...
{
  tUInt32 DEF__read__h121;
  DEF__read__h121 = INST_res.METH_read();
  if (!(PORT_RST_N == (tUInt8)0u))
  {
    dollar_display(sim_hdl, this, "s,32", &__str_literal_5, DEF__read__h121);
